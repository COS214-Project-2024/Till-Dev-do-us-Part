...
void Business::hireEmployee()
{
    ...
    else if (numEmployees[0] != numEmployees[1])
    {
        ...
        cout << "Maximum employess reached for " << this->getBusinessName() << endl;
}
...
void Business::fireEmployee()
{
    if (employees[0] != 0)
    {
        ...
        cout << this->getBusinessName() << " has no employees" << endl;
}
...
string Business::getBusinessDetails()
{
    ...
    if (wiseBucksApp != nullptr)
        ...
        output += "WiseBucks Service: WiseBucks has not been linked \n";
